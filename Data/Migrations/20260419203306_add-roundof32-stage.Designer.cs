...
namespace TipTournament2._0.Data.Migrations
{
    ...
    [Migration("20260419203306_add-roundof32-stage")]
    partial class addroundof32stage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TipTournament2._0.Models.BetsStatus", b =>
                {
                    ...
                    b.Property<bool>("RoundOf32StageDone")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("TipTournament2._0.Models.DeltaBet", b =>
                {
                    ...
                    b.Navigation("AwayTeamBet");

                    b.Navigation("HomeTeamBet");
